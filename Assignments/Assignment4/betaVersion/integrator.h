...
public:
    ...
    static dvec2 RK4(const VectorField2& vectorField, const dvec2& position,
                     const double& stepSize);
    static dvec2 RK4_stream(const VectorField2& vectorField, const dvec2& position,
                     const double& stepSize);
    static dvec2 normalize(const VectorField2& vectorField, const dvec2& position);
    static dvec2 Euler_stream(const VectorField2& vectorField, const dvec2& position,
                        const double& stepSize);
};
